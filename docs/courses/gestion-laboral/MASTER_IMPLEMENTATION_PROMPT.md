...
- Publica únicamente el PDF corporativo genérico, nunca versiones personalizadas.
...
- No publiques dossiers personalizados ni datos identificativos de clientes.
...
10. Verificar que ningún contenido personalizado de clientes es público.
