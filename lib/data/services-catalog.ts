...
export const SERVICES_CATALOG: CatalogSection[] = [
  {
    ...
    emoji: '🧾',
    cardBody: '📋 Fiscalidad para personas físicas: Renta, Modelo 151, No Residentes, Modelo 720 y más. ¿Qué necesitas?',
  ...
  },
  {
    ...
    services: [
      ...
      { id: 'inversores',                               title: 'Permiso Inversores',     description: 'Tramitación inicial y renovación · 250 €/persona' },
    ],
  },
  {
