...
export const KIA_AUDITOR_RULES: AuditorRuleDefinition[] = [
  ...
  {
    id:              'no_high_similarity_repeat',
    label:           'Sin repetición de alta similitud',
    category:        'consistency',
    severity:        'warning',
    evaluationType:  'deterministic',
    description:     'Kia debe variar estructura, apertura, cierre y CTA si la respuesta se parece >= 0.72 a un mensaje reciente.',
  },
  {
    id:              'history_checked_before_reply',
    label:           'Historial revisado antes de responder',
    category:        'consistency',
    severity:        'warning',
    evaluationType:  'deterministic',
    description:     'En decisiones estructuradas con historial reciente, rulesApplied debe incluir history_checked o anti_repetition_checked.',
  },
  {
  ...
  {
    id:              'quick_replies_required_for_clarification',
    label:           'Aclaraciones con respuestas rápidas',
    category:        'consistency',
    severity:        'warning',
    evaluationType:  'deterministic',
    description:     'Si Kia hace una pregunta aclaratoria en WABA, debe incluir quickReplies y terminar con Otro/Другое.',
  },
  {
  ...
  {
    id:              'friendly_tone_required',
    label:           'Tono cercano y profesional',
    category:        'tone',
    severity:        'info',
    evaluationType:  'deterministic',
    description:     'En WABA, Kia debe sonar amable y profesional, con emoji moderado cuando la interacción lo permite.',
  },
  {
    id:              'kia_identity_voice_required',
    label:           'Voz de Kia en femenino',
    category:        'tone',
    severity:        'warning',
    evaluationType:  'deterministic',
    description:     'Cuando responde Kia, debe identificarse como asistente virtual de EXPERT, hablar en femenino y no presentarse como equipo/humano.',
  },
  {
    id:              'no_parrot_behavior',
    label:           'Sin comportamiento de loro',
    category:        'consistency',
    severity:        'warning',
    evaluationType:  'deterministic',
    description:     'Kia falla si responde con estructura muy similar a dos o más mensajes recientes del mismo hilo.',
  },
];
