...
<table width="600" cellpadding="0" cellspacing="0" align="center" style="background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #d8cbb5;">
  ...
  <tr><td style="padding:40px;">
    ...
    <table width="100%" cellpadding="0" cellspacing="4" style="margin:22px 0;border-collapse:separate;">
      <tr>
        <td style="padding:10px 16px;font-size:13px;font-weight:bold;color:#07111d;background:#f8f4eb;border-radius:8px;">Plan</td>
        <td style="padding:10px 16px;font-size:14px;color:#29384a;">${safePlan}</td>
      </tr>
      <tr>
        <td style="padding:10px 16px;font-size:13px;font-weight:bold;color:#07111d;background:#f8f4eb;border-radius:8px;">Cuota mensual</td>
        <td style="padding:10px 16px;font-size:14px;color:#29384a;"><strong style="font-size:18px;color:#c88b25;">€${input.amountEur.toFixed(2)}/mes + IVA</strong></td>
      </tr>
    </table>
    <p style="text-align:center;margin:30px 0 16px;">
      <a href="${checkoutUrl}" style="display:inline-block;background:#c88b25;color:#061321;font-size:13px;font-weight:bold;text-transform:uppercase;letter-spacing:1.5px;padding:15px 32px;border-radius:50px;text-decoration:none;">Activar ${safePlan}</a>
    </p>
