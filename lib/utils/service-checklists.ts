...
export const SERVICE_CHECKLISTS: ServiceChecklist[] = [
  ...
  {
    serviceId: 'holded-migracion-sin-inventario',
    ...
    requiredData: [
      ...
      'Sistema de origen de los datos (ContaPlus, A3, Sage, Excel, otro)',
      'Años de historial a migrar',
      'Volumen estimado de registros: facturas emitidas + recibidas (aprox.)',
      'Si los datos están exportables (Excel/CSV) o solo accesibles en el sistema origen',
      'Si tiene facturas de proveedores a importar además de clientes',
      'Si tiene algún tipo de inventario, stock o referencias de producto',
    ],
    requiredDocs: [
    ...
    keyQuestions: [
      ...
      '¿Qué sistema usas actualmente para llevar la contabilidad/facturación?',
      '¿Cuántos años de historial quieres importar?',
      '¿Cuántas facturas aproximadamente tienes en total?',
      '¿Los datos los puedes exportar en Excel o CSV?',
      '¿Tienes inventario, almacén o referencias de producto?',
    ],
    botInstructions:
      'Migración sin inventario incluye facturas emitidas, recibidas, clientes y proveedores. NO incluye stock ni referencias de producto — si tiene inventario derivar a Migración con inventario. Requiere cuenta activa en Holded antes de iniciar — si no la tiene, ofrecer prueba gratuita 14 días primero. Si el volumen supera 10.000 registros o más de 3 años de historial, recomendar llamada para valorar el alcance. Precio: 899 € + IVA, pago único. Enlace: expertconsulting.es/holded.',
    estimatedPrice: '899 € + IVA',
  },

  {
    serviceId: 'holded-migracion-con-inventario',
    ...
    requiredData: [
      ...
      'Si necesita importar también historial de facturas además del inventario',
    ],
    requiredDocs: [
    ...
    keyQuestions: [
      '¿Ya tienes cuenta activa de Holded?',
      '¿Cuántas referencias de producto tienes aproximadamente?',
      '¿Los productos tienen variantes (talla, color, modelo)?',
      '¿Tienes más de un almacén?',
      '¿El inventario está en un sistema del que puedas exportar Excel o CSV?',
      '¿Quieres también importar el historial de facturas?',
    ],
    botInstructions:
      'Migración con inventario incluye maestro de productos, stock actual, variantes y almacenes, además de las facturas si se requiere. Requiere cuenta activa en Holded antes de iniciar. Si el número de referencias supera 2.000 o hay variantes complejas o múltiples almacenes, recomendar llamada para valorar alcance. No confundir con Pack Starter (solo configuración inicial sin datos) ni con Migración sin inventario. Precio: 1.199 € + IVA, pago único. Enlace: expertconsulting.es/holded.',
    estimatedPrice: '1.199 € + IVA',
  },
