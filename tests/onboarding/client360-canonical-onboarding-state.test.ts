...
describe('canonical subscription onboarding state', () => {
  ...
  it('exposes only the active subscription post-purchase marker to staff', () => {
  ...
  it('matches appointment email case-insensitively in both read and completion paths', () => {
