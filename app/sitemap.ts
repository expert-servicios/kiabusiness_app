...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/holded/conectores/claude/docs`,   changeFrequency: 'monthly', priority: 0.45, lastModified: now },
    { url: `${BASE}/holded/conectores/claude/privacy`, changeFrequency: 'yearly', priority: 0.2, lastModified: now },
    { url: `${BASE}/holded/conectores/claude/dpa`,    changeFrequency: 'yearly', priority: 0.2, lastModified: now },
