...
const NOT_INCLUDES = [
  { item: 'Integración en tiempo real con tienda online', alt: 'Requiere módulo de integración específico', href: null },
  { item: 'Automatización de pedidos ni sincronización continua', alt: null, href: null },
  { item: 'Desarrollo de integraciones API personalizadas', alt: null, href: null },
  ...
  { item: 'Formación en el módulo de inventario de Holded', alt: 'Ver Formación Holded', href: '/holded#formacion' },
];
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-3">
            ...
            <div className="border border-[#D4A017]/25 bg-white p-6">
              ...
              <p className="mt-2 text-sm leading-6 text-[#23364D]">
                Dejamos tu cuenta lista para conectar Claude a Holded: consulta facturas, stock o tesorería en lenguaje natural.
              </p>
              <Link
