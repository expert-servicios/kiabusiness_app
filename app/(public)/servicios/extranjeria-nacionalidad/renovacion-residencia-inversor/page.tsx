      ...
      <section className="px-6 py-14 md:py-18">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2">
            {documents.map((block) => (
              <div key={block.title} className="border border-[#e4d8c1] bg-white p-6">
                <div className="flex items-center gap-3">
                  {block.title.includes('Familiares') ? <Users className="h-5 w-5 text-[#D4A017]" /> : <FileText className="h-5 w-5 text-[#D4A017]" />}
