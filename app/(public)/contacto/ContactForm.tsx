  ...
  return (
    <form onSubmit={handleSubmit} className="mt-6 space-y-4">
      ...
      <div>
        ...
        <input type="tel" inputMode="tel" pattern="(?=.*[0-9])[+]?[0-9\s().-]{7,20}" title="Introduce un teléfono válido (7-20 dígitos, puede incluir +, espacios o guiones)" value={form.telefono} onChange={(e) => set('telefono', e.target.value)} placeholder="+34 600 000 000" className={inputCls} />
      </div>
