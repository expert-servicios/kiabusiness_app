...
export const metadata: Metadata = {
  ...
  openGraph: {
    type: 'website',
    url: 'https://expertconsulting.es/condiciones',
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-10 space-y-10">
          ...
          <Section title="2. Ámbito de aplicación y aceptación">
            <p>
              Estas Condiciones se aplican a toda contratación de servicios profesionales realizada a través del sitio web <strong>expertconsulting.es</strong> y su plataforma privada de cliente, con independencia del canal por el que se formalice el presupuesto (web, email o WhatsApp).
            </p>
            <p>
