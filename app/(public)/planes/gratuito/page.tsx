          ...
          <form onSubmit={handleSubmit} className="mt-10 space-y-5">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <div>
                ...
                <input
                  type="tel" name="phone" inputMode="tel" pattern="(?=.*[0-9])[+]?[0-9\s().-]{7,20}" title="Introduce un teléfono válido (debe incluir al menos un dígito, 7-20 caracteres, puede incluir +, espacios o guiones)" value={form.phone} onChange={handleChange} required
