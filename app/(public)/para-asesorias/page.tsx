...
const benefits = [
  {
    ...
    text: 'Automatizaciones para presupuestos, documentación pendiente, avisos de estado, pagos fallidos y seguimiento.'
  },
  {
    title: 'Más control operativo',
    text: 'Una vista clara de expedientes bloqueados, documentos por revisar y tareas que requieren acción.'
  },
  {
    ...
    <main className="bg-[#F8F6F1] text-[#0D1B2A]">
      <section className="brand-blue-bg px-6 py-16 text-[#F8F6F1] md:py-20">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1fr_0.82fr] lg:items-center">
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.28em] text-[#D4A017]">Para asesorías</p>
      ...
      <section id="b2b-form" className="px-6 pb-16 md:pb-24">
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.72fr_1fr] lg:items-start">
          <div>
            ...
            <h2 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl">
              Cuéntanos cómo trabaja tu despacho
            </h2>
            <p className="mt-4 text-sm leading-7 text-[#23364D] md:text-base">
      ...
      <section className="brand-blue-bg px-6 py-14 text-center text-[#F8F6F1]">
        <div className="mx-auto max-w-3xl">
          ...
          <h2 className="mt-4 font-serif text-3xl font-bold leading-tight md:text-4xl">
            EXPERT sigue siendo primero una asesoría digital para clientes finales.
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-[#9CA3AF]">
            Esta página valida la visión SaaS futura sin cambiar la navegación principal ni distraer la contratación actual de servicios.
          </p>
          <Link
            href="/servicios"
