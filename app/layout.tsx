    ...
    <html lang="es">
      <body className={`${inter.variable} ${playfair.variable} font-sans`}>
        ...
        <a
          ...
          className="fixed bottom-5 right-5 z-[70] flex h-14 w-14 items-center justify-center rounded-full bg-[#D4A017] text-[#0D1B2A] shadow-[0_16px_35px_rgba(13,27,42,0.28)] transition hover:scale-105 hover:bg-[#F2C14E] focus:outline-none focus:ring-4 focus:ring-[#D4A017]/30"
        >
