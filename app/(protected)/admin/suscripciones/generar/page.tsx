    ...
    <main className="min-h-screen bg-[#f8f4eb] px-6 py-8 text-[#07111d]"><div className="mx-auto max-w-5xl">
      ...
      {result && <>
        ...
        <section className="mt-5 rounded-2xl border border-[#d8cbb5] bg-white p-6 shadow-sm">
          ...
          {result.reused && !emailSent && <div className="mt-4 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs leading-5 text-amber-900"><strong>Control de duplicados externos:</strong> este Checkout ya existía y EXPERT no tiene un envío propio registrado. Eso no demuestra que no se haya enviado por Outlook/Gmail u otro canal. Revisa Comunicaciones antes de enviarlo desde aquí.</div>}
