const SUPPORT_EMAIL = 'info@expertconsulting.es';
// CONNECT_URL is derived from baseUrl at render time (renderLandingPage receives it).
// This makes subdomain swaps (e.g. claude.expertconsulting.es → holded-claude.expertconsulting.es)
...
const TRUST_POINTS = [
  ...
  'Credenciales protegidas en servidores de EXPERT; no se muestran a la IA ni al cliente.',
...
export function renderLandingPage(baseUrl: string, publicBase = 'https://expertconsulting.es/holded/conectores/claude') {
  const connectHref = escapeHtml(`${baseUrl.replace(/\/$/, '')}/launch`);
  const holdedBase = escapeHtml(publicBase.replace(/\/$/, ''));
...
<head>
  ...
  <title>Pregunta a Holded desde Claude | EXPERT</title>
  ...
  <div class="w">
    ...
    <div class="steps-grid">
      ...
      <div class="step-card">
        ...
        <p>La pantalla segura de EXPERT solicita tu API key de Holded. Se guarda en servidor y no se devuelve a Claude ni al navegador.</p>
      </div>
    </div>
    ...
    <div class="step-note">
      ...
      <span>
        Si ya tienes cuenta en EXPERT, el flujo puede detectar tu sesión activa y omitir
  ...
  <div class="w">
    ...
    <div class="how-grid">
      <div class="how-card">
        ...
        <p>Empieza desde Claude o desde el acceso directo de EXPERT. Solo necesitas tu API key de Holded y una cuenta autorizada.</p>
      </div>
      <div class="how-card">
        <span class="how-n">02</span>
        <div class="icon-box" style="width:2.5rem;height:2.5rem;margin:.75rem 0;font-size:1.25rem;">&#128274;</div>
        <h3>Autoriza Holded</h3>
        <p>EXPERT valida la API key y guarda la conexión en servidor. Las credenciales no se devuelven a Claude ni al navegador.</p>
      </div>
      <div class="how-card">
  ...
  <div class="w">
    ...
    <div class="support-grid">
      ...
      <a href="${mailtoHref}" class="support-card">
        <div class="icon-box">&#9993;</div>
        <h3>Email directo</h3>
        <p>Para incidencias urgentes o con adjuntos, escribe a ${escapeHtml(SUPPORT_EMAIL)}.</p>
...
<section class="footer-cta">
  <div class="w-md">
    <div class="footer-badge">
      &#10003; Operado por EXPERT &mdash; no por Anthropic ni Holded
    </div>
