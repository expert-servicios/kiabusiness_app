...
export function installTestEnv(overrides: Record<string, string | undefined> = {}) {
  process.env.NODE_ENV = 'test';
  process.env.PORT = process.env.PORT || '3000';
  process.env.BASE_URL = 'https://claude.expertconsulting.es';
  ...
  process.env.EXPERT_APP_URL = 'https://expertconsulting.es';
  process.env.EXPERT_PUBLIC_URL = 'https://expertconsulting.es';
  process.env.EXPERT_APP_SHARED_SECRET = 'test-expert-shared-secret-1234567890';
  process.env.SESSION_SECRET = 'test-session-secret-1234567890';
  process.env.EXPERT_OAUTH_BRIDGE_ENABLED = '1';
  process.env.EXPERT_CENTRAL_REGISTRY_ENABLED = '1';
...
export async function startTestServer(overrides: Record<string, string | undefined> = {}) {
  installTestEnv(overrides);
