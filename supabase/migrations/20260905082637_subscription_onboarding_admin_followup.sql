...
after insert or update of status, post_purchase_onboarding_at on public.subscriptions
for each row execute function public.sync_subscription_onboarding_admin_followup();
