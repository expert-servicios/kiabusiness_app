...
COMMENT ON COLUMN public.documents.uploaded_by_role IS 'Who uploaded the file: client (client-provided input) or admin (deliverable/result from the advisory team)';
