...
comment on function public.sync_subscription_checkout_claim_status() is 'Synchronizes terminal checkout_sessions status into subscription checkout claims; forward-only, no historical backfill.';
